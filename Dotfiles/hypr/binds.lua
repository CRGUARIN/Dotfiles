...
-- Reminder --
local reminder = "~/Scripts/hypr-reminder.sh"
local reminderList = "~/Scripts/hypr-reminder.sh show"
local reminderClear = "~/Scripts/hypr-reminder.sh clear"

local pkgtui = "kitty --class floatm -e ~/Scripts/pkgtui.sh"
local powerProfile = "~/Scripts/power_profile.sh"
local power = "~/Scripts/power.sh"
local changeWallpaper = "~/Scripts/change-wallpaper.sh"
...
hl.bind(mainMod .. " + CONTROL + S", hl.dsp.exec_cmd(power))
hl.bind(mainMod .. " + CONTROL + P", hl.dsp.exec_cmd(powerProfile))
hl.bind("XF86Calculator", hl.dsp.exec_cmd("kitty --class floats -e qalc"))
hl.bind(mainMod .. " + CONTROL + I", hl.dsp.exec_cmd(pkgtui))

---- Utilities (Screenshots, Wallpaper, UI) ----

hl.bind("Print", hl.dsp.exec_cmd('grim -g "$(slurp)" - | swappy -f -'))
hl.bind(mainMod .. " + ALT + W", hl.dsp.exec_cmd(changeWallpaper))
